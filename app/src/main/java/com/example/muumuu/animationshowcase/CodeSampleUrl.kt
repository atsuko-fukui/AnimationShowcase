...
enum class CodeSampleUrl(val url: String) {
    SCALE_BUTTON("https://github.com/atsuko-fukui/AnimationShowcase/blob/master/app/src/main/java/com/example/muumuu/animationshowcase/ScaleButtonFragment.kt"),
    ...
    SELECTED_ITEMS("https://github.com/atsuko-fukui/AnimationShowcase/blob/master/app/src/main/res/layout/fragment_selectable_item.xml"),
    CROP_TO_OUTLINE("https://github.com/atsuko-fukui/AnimationShowcase/blob/master/app/src/main/java/com/example/muumuu/animationshowcase/CropToOutlineFragment.kt")
}